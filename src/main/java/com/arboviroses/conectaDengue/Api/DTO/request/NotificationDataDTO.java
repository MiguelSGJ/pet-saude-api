...
public class NotificationDataDTO {
    @NotNull(message = "Numero da notificacao e obrigatorio")
    @Min(value = 1, message = "Numero da notificacao invalido")
    ...
    @Pattern(regexp = InputPatterns.DATE_BR, message = "Data dos sintomas deve estar no formato dd/MM/yyyy")
