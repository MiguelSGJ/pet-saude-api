...
@AllArgsConstructor
@NoArgsConstructor
public class NotificationErrorWithCategoryDTO {
    ...
    public NotificationErrorWithCategoryDTO(NotificationWithError n, String category) {
